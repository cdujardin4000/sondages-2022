...
var_dump($result);
	...
	private function createDataBase() {
		$this->connection->query('CREATE TABLE users(nickname char (20), password char (50))');
		$this->connection->query('CREATE TABLE surveys(id INTEGER PRIMARY KEY AUTOINCREMENT, owner char (20), question char (255))');
		$this->connection->query('CREATE TABLE responses(id INTEGER PRIMARY KEY AUTOINCREMENT,idSurvey INTEGER,title char (255),count INTEGER)');
	}
